...
@class SWGTechnicianReportItem;



@protocol SWGReportingTechniciansResponse
@end

@interface SWGReportingTechniciansResponse : SWGObject
...
@property(nonatomic) NSArray<SWGTechnicianReportItem>* results;
