...
@class SWGCustomerLocation;
@protocol SWGCustomerUser;
@class SWGCustomerUser;



@protocol SWGCustomerCreateRequest
@end

@interface SWGCustomerCreateRequest : SWGObject


@property(nonatomic) SWGCustomer* customer;

@property(nonatomic) SWGCustomerUser* customerUser;

@property(nonatomic) SWGCustomerLocation* customerLocation;
