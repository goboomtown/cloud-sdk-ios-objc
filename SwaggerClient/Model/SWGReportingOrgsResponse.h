...
@class SWGOrgReportItem;
@protocol SWGReportHeadersItem;
@class SWGReportHeadersItem;



@protocol SWGReportingOrgsResponse
@end

@interface SWGReportingOrgsResponse : SWGObject
...
@property(nonatomic) NSArray<SWGOrgReportItem>* results;
