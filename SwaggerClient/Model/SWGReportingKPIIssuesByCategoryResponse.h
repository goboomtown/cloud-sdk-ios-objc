...
@protocol SWGReportingKPIIssuesByCategoryResponseResults;
@class SWGReportingKPIIssuesByCategoryResponseResults;



@protocol SWGReportingKPIIssuesByCategoryResponse
@end

@interface SWGReportingKPIIssuesByCategoryResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPIIssuesByCategoryResponseResults>* results;
