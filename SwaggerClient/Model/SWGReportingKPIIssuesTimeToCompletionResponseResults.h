...
@protocol SWGReportingKPIIssuesTimeToCompletionResponseResults
@end

@interface SWGReportingKPIIssuesTimeToCompletionResponseResults : SWGObject
...
@property(nonatomic) NSNumber* averageTimeToCompletion;

@property(nonatomic) NSNumber* sumTimeToCompletion;

@property(nonatomic) NSString* timeInterval;

@property(nonatomic) NSString* category;

@property(nonatomic) NSNumber* issues;
