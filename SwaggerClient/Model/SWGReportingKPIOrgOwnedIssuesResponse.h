...
@protocol SWGReportingKPIOrgOwnedIssuesResponseResults;
@class SWGReportingKPIOrgOwnedIssuesResponseResults;



@protocol SWGReportingKPIOrgOwnedIssuesResponse
@end

@interface SWGReportingKPIOrgOwnedIssuesResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPIOrgOwnedIssuesResponseResults>* results;
