...
@protocol SWGReportingKPIAverageTimeToScheduledResponseResults;
@class SWGReportingKPIAverageTimeToScheduledResponseResults;



@protocol SWGReportingKPIAverageTimeToScheduledResponse
@end

@interface SWGReportingKPIAverageTimeToScheduledResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPIAverageTimeToScheduledResponseResults>* results;
