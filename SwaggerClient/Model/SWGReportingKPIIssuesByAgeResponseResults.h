...
@protocol SWGReportingKPIIssuesByAgeResponseResults
@end

@interface SWGReportingKPIIssuesByAgeResponseResults : SWGObject
...
@property(nonatomic) NSNumber* last24Hrs;

@property(nonatomic) NSNumber* last7Days;

@property(nonatomic) NSNumber* last30Days;

@property(nonatomic) NSNumber* allTime;
