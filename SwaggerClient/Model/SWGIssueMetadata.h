...
@interface SWGIssueMetadata : SWGObject

/* Preferred installation date [optional]
 */
@property(nonatomic) NSString* preferredInstallDate;
/* Preferred installation time-slot (AM/PM) [optional]
 */
@property(nonatomic) NSString* preferredTimeFrame;
/* Alternative preferred installation date [optional]
 */
@property(nonatomic) NSString* alternateInstallDate;
/* Alternative preferred installation time-slot (AM/PM) [optional]
 */
@property(nonatomic) NSString* alternateTimeFrame;
/* Number of POS devices [optional]
 */
@property(nonatomic) NSNumber* numberOfPosDevices;
