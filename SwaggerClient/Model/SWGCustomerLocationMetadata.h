...
@interface SWGCustomerLocationMetadata : SWGObject

/* Location Technology Notes [optional]
 */
@property(nonatomic) NSString* locationTechnologyNotes;
/* Unique Connectivity Details [optional]
 */
@property(nonatomic) NSString* uniqueAspectsThatAffectConnectivity;
/* Terminal ID (TID) [optional]
 */
@property(nonatomic) NSString* terminalIdentificationNumber;
