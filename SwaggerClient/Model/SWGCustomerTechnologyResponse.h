...
@class SWGBaseResponse;
@protocol SWGCustomerTechnology;
@class SWGCustomerTechnology;



@protocol SWGCustomerTechnologyResponse
@end

@interface SWGCustomerTechnologyResponse : SWGObject
...
/* Total objects available [optional]
 */
@property(nonatomic) NSNumber* totalCount;
/* Total objects retrieved [optional]
 */
...
@property(nonatomic) NSArray<SWGCustomerTechnology>* results;
