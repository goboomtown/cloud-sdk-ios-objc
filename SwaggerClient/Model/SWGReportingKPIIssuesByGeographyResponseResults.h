...
@protocol SWGReportingKPIIssuesByGeographyResponseResults
@end

@interface SWGReportingKPIIssuesByGeographyResponseResults : SWGObject
...
@property(nonatomic) NSString* divisionUnit;

@property(nonatomic) NSString* divisionValue;
