...
@protocol SWGReportingKPIIssuesByLocationResponseResults;
@class SWGReportingKPIIssuesByLocationResponseResults;



@protocol SWGReportingKPIIssuesByLocationResponse
@end

@interface SWGReportingKPIIssuesByLocationResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPIIssuesByLocationResponseResults>* results;
