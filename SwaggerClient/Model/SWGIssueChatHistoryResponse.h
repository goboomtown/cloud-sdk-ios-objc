...
@class SWGIssueChatHistory;



@protocol SWGIssueChatHistoryResponse
@end

@interface SWGIssueChatHistoryResponse : SWGObject
...
@property(nonatomic) NSArray<SWGIssueChatHistory>* results;
