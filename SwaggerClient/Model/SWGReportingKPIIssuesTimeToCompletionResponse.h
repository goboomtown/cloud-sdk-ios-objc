...
@class SWGReportingKPIIssuesTimeToCompletionResponseResults;



@protocol SWGReportingKPIIssuesTimeToCompletionResponse
@end

@interface SWGReportingKPIIssuesTimeToCompletionResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPIIssuesTimeToCompletionResponseResults>* results;
