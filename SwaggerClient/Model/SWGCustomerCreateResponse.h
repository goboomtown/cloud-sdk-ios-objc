...
@protocol SWGCustomerTuple;
@class SWGCustomerTuple;



@protocol SWGCustomerCreateResponse
@end

@interface SWGCustomerCreateResponse : SWGObject
...
@property(nonatomic) SWGCustomerTuple* results;
