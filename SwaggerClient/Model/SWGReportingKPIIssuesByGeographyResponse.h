...
@class SWGReportingKPIIssuesByGeographyResponseResults;



@protocol SWGReportingKPIIssuesByGeographyResponse
@end

@interface SWGReportingKPIIssuesByGeographyResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPIIssuesByGeographyResponseResults>* results;
