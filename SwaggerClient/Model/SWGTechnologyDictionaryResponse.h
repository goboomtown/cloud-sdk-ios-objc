...
@protocol SWGTechnologyDictionaryResponse
@end

@interface SWGTechnologyDictionaryResponse : SWGObject
...
/* Dictionary of ID to names. The `id` property is an example: it will actually be an ID of a type [optional]
 */
