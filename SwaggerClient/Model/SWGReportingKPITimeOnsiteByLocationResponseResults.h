...
@interface SWGReportingKPITimeOnsiteByLocationResponseResults : SWGObject
...
@property(nonatomic) NSNumber* totalTimeOnsite;

@property(nonatomic) NSNumber* averageTimeOnsite;
