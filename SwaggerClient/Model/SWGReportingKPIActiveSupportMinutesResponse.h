...
@protocol SWGReportingKPIActiveSupportMinutesResponseResults;
@class SWGReportingKPIActiveSupportMinutesResponseResults;



@protocol SWGReportingKPIActiveSupportMinutesResponse
@end

@interface SWGReportingKPIActiveSupportMinutesResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPIActiveSupportMinutesResponseResults>* results;
