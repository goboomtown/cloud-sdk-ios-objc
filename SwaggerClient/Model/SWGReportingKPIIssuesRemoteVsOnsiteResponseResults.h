...
@interface SWGReportingKPIIssuesRemoteVsOnsiteResponseResults : SWGObject
...
@property(nonatomic) NSString* orgTeamId;

@property(nonatomic) NSString* orgTeam;

@property(nonatomic) NSNumber* remoteIssues;

@property(nonatomic) NSNumber* remote;

@property(nonatomic) NSNumber* onsiteIssues;

@property(nonatomic) NSNumber* onsite;

@property(nonatomic) NSNumber* totalIssues;
