...
@protocol SWGReportingKPIIssuesRemoteVsOnsiteResponseResults;
@class SWGReportingKPIIssuesRemoteVsOnsiteResponseResults;



@protocol SWGReportingKPIIssuesRemoteVsOnsiteResponse
@end

@interface SWGReportingKPIIssuesRemoteVsOnsiteResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPIIssuesRemoteVsOnsiteResponseResults>* results;
