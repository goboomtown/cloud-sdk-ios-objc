...
@protocol SWGHashMapOfStrings;
@class SWGHashMapOfStrings;



@protocol SWGHashMapResponse
@end

@interface SWGHashMapResponse : SWGObject
...
@property(nonatomic) SWGHashMapOfStrings* results;
