...
@class SWGReportingKPIIssuesByAgeResponseResults;



@protocol SWGReportingKPIIssuesByAgeResponse
@end

@interface SWGReportingKPIIssuesByAgeResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPIIssuesByAgeResponseResults>* results;
