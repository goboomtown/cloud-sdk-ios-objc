...
@protocol SWGCustomFormField;
@class SWGCustomFormField;
...
@interface SWGCustomForm : SWGObject
...
@property(nonatomic) NSArray<NSString*>* orgTeamIds;

@property(nonatomic) NSDate* created;

@property(nonatomic) NSDate* updated;

@property(nonatomic) NSArray<SWGCustomFormField>* fields;
