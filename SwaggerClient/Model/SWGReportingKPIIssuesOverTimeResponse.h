...
@class SWGReportingKPIIssuesOverTimeResponseResults;



@protocol SWGReportingKPIIssuesOverTimeResponse
@end

@interface SWGReportingKPIIssuesOverTimeResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPIIssuesOverTimeResponseResults>* results;
