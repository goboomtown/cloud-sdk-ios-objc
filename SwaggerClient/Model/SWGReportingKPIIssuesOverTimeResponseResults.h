...
@protocol SWGReportingKPIIssuesOverTimeResponseResults
@end

@interface SWGReportingKPIIssuesOverTimeResponseResults : SWGObject
...
@property(nonatomic) NSString* intervalLabel;

@property(nonatomic) NSString* intervalDate;
