...
@protocol SWGReportingKPITimeOnsiteByLocationResponseResults;
@class SWGReportingKPITimeOnsiteByLocationResponseResults;



@protocol SWGReportingKPITimeOnsiteByLocationResponse
@end

@interface SWGReportingKPITimeOnsiteByLocationResponse : SWGObject
...
@property(nonatomic) NSArray<SWGReportingKPITimeOnsiteByLocationResponseResults>* results;
